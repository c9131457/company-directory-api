...
<template>
    <!-- {{route.params.id}} -->
    <main>
        <div v-if="currentEmployee" class="flex flex-col items-center justify-canter gap-6">
            ...
            <h1 class="text-2xl p-5">{{ currentEmployee.userName }} @southteaxscollege.com</h1>
            <h1 class="text-2xl p-5">{{ currentEmployee.quote }}</h1>

            <img call="p-8 " :src="faker.image.urlLoremFlicker({category: 'cat'})"/>
